...
// fire from any project cwd and the balance should follow Claude everywhere.
export const DATA_DIR = path.join(os.homedir(), ".claude-token-economy");

export const LEDGER_PATH = path.join(DATA_DIR, "ledger.json");
export const STATE_PATH = path.join(DATA_DIR, "state.json");
export const CONFIG_PATH = path.join(DATA_DIR, "config.json");

// Where `cte install-hooks` writes. Claude Code reads hooks from here.
